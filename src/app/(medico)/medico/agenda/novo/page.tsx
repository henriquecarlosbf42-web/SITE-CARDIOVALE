...
export const metadata: Metadata = { title: "Agendar consulta | Portal do médico" };
...
export default async function NovaConsultaPage({
  ...
  return (
    <div className="mx-auto max-w-lg">
      <h1 className="text-center text-2xl font-semibold text-ink-900">Agendar consulta</h1>
      ...
      <div className="mt-6 rounded-card border border-ink-100 bg-surface p-6 shadow-soft">
        <AppointmentForm patientId={patient.id} defaultDate={today} />
      </div>
    </div>
  );
}
